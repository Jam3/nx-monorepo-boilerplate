...
function getLayout(): BreakpointLayout {
  ...
  return {
    get mobile() {
      return (
        !this.tablet && !this.desktopSm && !this.desktopMd && !this.desktopLg
      );
    },
    get tablet() {
      return (
        TABLET_MATCH_MEDIA.matches &&
        !this.desktopSm &&
        !this.desktopMd &&
        !this.desktopLg
      );
    ...
    get desktopSm() {
      return (
        DESKTOP_SM_MATCH_MEDIA.matches && !this.desktopMd && !this.desktopLg
      );
    },
    get desktopMd() {
